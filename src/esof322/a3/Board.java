...
public class Board 
{
	...
	public Board(){
		...
		board[1] = new Property("MediterraneanAvenue", 60, new int[] {2, 10, 30, 90, 160, 250}, 50, 30, 1, 1243, 1425, 0, 2);
		board[2] = new CommunityChest(1119, 1425);
		board[3] = new Property("BalticAvenue", 60, new int[] {4, 20, 60, 180, 320, 450}, 50, 30, 2, 994, 1425, 0, 2);
		...
		board[13] = new Property("StatesAvenue", 140, new int[] {10, 50, 150, 450, 625, 750}, 100, 70, 2, 75, 994, 2, 3);
		board[14] = new Property("VirginiaAvenue", 160, new int[] {12, 60, 180, 500, 700, 900}, 100, 80, 3, 75, 871, 2, 3);
		board[15] = new Railroad("PennsylvaniaRailroad", 75, 750);
		board[16] = new Property("St.JamesPlace", 180, new int[] {14, 70, 200, 550, 750, 950}, 100, 90, 1, 75, 626, 3, 3);
		board[17] = new CommunityChest(75, 506);
		board[18] = new Property("TennesseeAvenue", 180, new int[] {14, 70, 200, 550, 750, 950}, 100, 90, 2, 75, 386, 3, 3);
		board[19] = new Property("NewYorkAvenue", 200, new int[] {16, 80, 220, 600, 800, 1000}, 100, 100, 3, 75, 262, 3, 3);
		board[20] = new FreeParking(100, 100);
		board[21] = new Property("KentuckyAvenue", 220, new int[] {18, 90, 250, 700, 875, 1050}, 150, 110, 1, 262, 75, 4, 3);
		board[22] = new Chance(386, 75);
		board[23] = new Property("IndianaAvenue", 220, new int[] {18, 90, 250, 700, 875, 1050}, 150, 110, 2, 506, 75, 4, 3);
		board[24] = new Property("IllinoisAvenue", 240, new int[] {20, 100, 300, 750, 925, 1100}, 150, 120, 3, 625, 75, 4, 3);
		board[25] = new Railroad("BAndORailroad", 750, 75);
		board[26] = new Property("AtlanticAvenue", 260, new int[] {22, 110, 330, 800, 975, 1150}, 150, 130, 1, 871, 75, 5, 3);
		board[27] = new Property("VentnorAvenue", 260, new int[] {22, 110, 330, 800, 975, 1150}, 150, 130, 2, 994, 75, 5, 3);
		board[28] = new Utility("WaterWorks", 1119,75);
		board[29] = new Property("Marvin Gardens", 280, new int[] {24, 120, 360, 850, 1025, 1200}, 150, 140, 3, 1243,75, 5, 3);
		board[30] = new GoToJail(1400, 75);
		board[31] = new Property("PacificAvenue", 300, new int[] {26, 130, 390, 900, 1100, 1275}, 200, 150, 1, 1425, 262, 6, 3);
		board[32] = new Property("NorthCarolinaAvenue", 300, new int[] {26, 130, 390, 900, 1100, 1275}, 200, 150, 2, 1425, 386, 6, 3);
