...
public class CommunityChestDeck {
	...
	public CommunityChestDeck(){
		...
		deck.add(new Card ("Advance to go. \n Collect $200", 1, 0, 0, PASS_GO_BONUS));
		deck.add(new Card ("Bank error in your favor \n Collect $200", 1, 0, 0, PASS_GO_BONUS));
		...
		deck.add(new Card ("Grand Opera Night  \n Collect $50 from every player for opening night seats", 5, 0, 0, 50));
		...
		deck.add(new Card ("You are assessed for street repairs \n $40 per house – $115 per hotel", 4, 0, 0, 0));
		deck.add(new Card ("You have won second prize in a beauty contest \n Collect $10", 2, 0, 0, 10));	
